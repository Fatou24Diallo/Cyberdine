 ...
 */
final class Version20210607202022 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user RENAME INDEX uniq_8d93d6495e237e06 TO UNIQ_8D93D649F85E0677');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user RENAME INDEX uniq_8d93d649f85e0677 TO UNIQ_8D93D6495E237E06');
    }
}
